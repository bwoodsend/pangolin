...
<https://github.com/bwoodsend/pangolin/issues>`_.
...
`Github discussions <https://github.com/bwoodsend/pangolin/discussions/>`_.
...
proposed as `discussions on Github <https://github.com/bwoodsend/pangolin/discussions/>`_
first. However, be warned that I am very picky about what should and should not
be added to ``pangolin``. Features will be rejected if
...
#. I'm a big believer of the Linux *small packages that do one thing well*
   ...
   feature should instead be its own package which depends on both ```pangolin`` and these other dependencies.
